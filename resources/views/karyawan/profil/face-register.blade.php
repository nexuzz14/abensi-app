...
<div class="d-flex align-items-center mb-4 gap-3">
    <a href="{{ route('karyawan.profil.index') }}" class="btn btn-sm btn-outline-secondary">
...
<div class="row g-4">
    ...
    <div class="col-12 col-lg-5">
        ...
        <div class="result-card" id="resultCard">
            ...
            <a href="{{ route('karyawan.profil.index') }}" class="btn btn-success btn-sm fw-bold">
        ...
        <div class="content-card">
            ...
            <div class="content-card-body">
                <table style="font-size:0.85rem;width:100%">
                    ...
                    <tr>
                        <td style="color:#94a3b8;padding:0.3rem 0">No. HP</td>
...
<script>
    ...
    const STORE_URL   = '{{ route('karyawan.profil.face-store', [], false) }}';
    ...
    async function loadModels() {
        addLog('Memuat semua model AI secara paralel...', 'info');
        ...
        addLog(`✅ Semua model dimuat! (${ms}ms)`, 'success');
    }
    ...
    async function simpanDescriptor() {
        ...
        // Hitung rata-rata dari semua descriptor (128 nilai masing-masing)
        // Rata-rata descriptor memberikan representasi wajah yang lebih robust
        ...
        addLog(`📊 Descriptor dari ${descriptors.length} sampel, rata-rata dihitung.`, 'info');
